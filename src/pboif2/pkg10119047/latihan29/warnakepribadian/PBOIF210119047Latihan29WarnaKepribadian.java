 ...
 */
package pboif2.pkg10119047.latihan29.warnakepribadian;
...
public class PBOIF210119047Latihan29WarnaKepribadian {
    ...
    //convert huruf
     public static String HurufBesar(String warna){
    ...
    public static void validasi(String warna){
        ...
        switch(HurufBesar(warna)){
            case "MERAH" -> getMerah(warna);
            case "HIJAU" -> getHijau(warna);
            case "KUNING" -> getKuning(warna);
            case "BIRU" -> getBiru(warna);
            case "UNGU" -> getUngu(warna);
            default -> System.out.println("Opps.. Belum teridentifikasi");
        }
    }
    
    public static void getMerah(String warna){
        System.out.println(normal + "Warna Favoritmu adalah " + red + HurufBesar(warna));
    ...
    public static void getHijau(String warna){
        System.out.println(normal + "Warna Favoritmu adalah " + green + HurufBesar(warna));
    ...
    public static void getKuning(String warna){
        System.out.println(normal + "Warna Favoritmu adalah " + yellow + HurufBesar(warna));
    ...
    public static void getBiru(String warna){
        System.out.println(normal + "Warna Favoritmu adalah " + blue + HurufBesar(warna));
    ...
    public static void getUngu(String warna){
        System.out.println(normal + "Warna Favoritmu adalah " + purple + HurufBesar(warna));
        System.out.println("1. Optimis,");
